...
task.wait(0.5)
print("ORIGINAL SCRIPTER: @nas9229alt (Nas Dev)")
task.wait(0.01)
print("CONTINUED BY: @1602sasa2 (Jan)")
task.wait(0.01)
...
pcall(function()
    ...
    local msg = "NasGUI v2.5 Continuation Loaded! | Original by: nas9229alt, Continued by: 1602sasa2"
...
scrollPlugins.Size = UDim2.new(1, -20, 1, 0)
